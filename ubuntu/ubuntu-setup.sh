...
sudo apt-get install build-essential idle idle3 ipython ipython3 jupyter ruby openjdk-8-jdk openjdk-8-doc openjdk-8-source mc synaptic chromium-browser gedit gedit-plugins geany geany-plugins dia dia2code planner libreoffice aptitude gdebi wget vlc audacious lame ubuntu-restricted-addons libavcodec-extra shutter recordmydesktop python3-scipy python-scipy python-matplotlib python3-matplotlib python-matplotlib-doc ssh zssh zsh zsh-doc fish zip unzip  unace p7zip-full arj cabextract bluefish vim thunderbird codeblocks doxygen doxygen-doc doxygen-gui git git-doc git-extras git-gui git-hub uncrustify ruby-beautify sed gawk finger thonny -y
